...
def getConfig():
    ...
    uh = urlopen('http://gastrodia.hk:3000/speedtest-config.php')
    configxml = []
    while 1:
...
def closestServers(client, all=False):
    ...
    uh = urlopen('http://gastrodia.hk:3000/speedtest-servers-static.php')
    serversxml = []
    while 1:
...
def speedtest():
    ...
    if args.share and args.mini:
        ...
        req = Request('http://gastrodia.hk:3000/api/api.php',
        ...
        print_('Share results: http://gastrodia.hk:3000/result/%s.png' %
               resultid[0])
